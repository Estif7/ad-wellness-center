(function ($) {
    ...
    function updateMobileAuthMenu(isLoggedIn, welcomeText) {
        $('.slicknav_menu .mobile-auth-item').remove();

        let authHTML = '';

        if (isLoggedIn) {
            authHTML += `
                <li class="slicknav_item mobile-auth-item">
                    <div class="mobile-user-info">
                        ${welcomeText}
                    </div>
                </li>
                <li class="slicknav_item mobile-auth-item">
                    <a href="#" class="mobile-logout-btn" onclick="logout()">Logout</a>
                </li>`;
        } else {
            authHTML += `
                <li class="slicknav_item mobile-auth-item">
                    <a href="#" class="mobile-login-btn" onclick="login()">Login</a>
                </li>`;
        }

        $('.slicknav_menu ul').append(authHTML);
    }

    // Make it globally accessible
    window.updateMobileAuthMenu = updateMobileAuthMenu;
